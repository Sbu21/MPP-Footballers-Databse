...
const seedDb = async () => {
    ...
    const car1 = new Car({make: "Mercedes", model: "CLA", year: "2020", price: 30000, image: "https://upload.wikimedia.org/wikipedia/commons/7/71/Mercedes-Benz_C118_IMG_2673.jpg"});
    await car1.save();
    ...
    await car3.save();
    const car4 = new Car({make: "Audi", model: "A4", year: "2019", price: 20000, image: "https://t4.ftcdn.net/jpg/04/51/65/87/360_F_451658744_Bm9QLAj1D0nluOkPHDKVXKTSZ6jRBOOS.jpg"});
    await car4.save();
    const car5 = new Car({make: "BMW", model: "M4", year: "2023", price: 90000, image: "https://ireland.apollo.olxcdn.com/v1/files/eyJmbiI6Imk3dnVjcG93NWhpcDMtQVVUT1ZJVFJPIn0.-Vn6Nw9AKoccB9mU2OtHRoCswQQBglGSWp_f2lLqTAA/image;s=644x461"});
    await car5.save();
}
